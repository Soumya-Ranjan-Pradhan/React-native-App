...
const AddMarkupLinkProps = ({ sheetModal, setSheetModal, selectedSheet }) => {
  return (
    <Modal
      isVisible={sheetModal}
      backdropColor="transparent"
      onBackdropPress={() => setSheetModal(false)}
    >
      <View style={styles.container}>
        <View style={styles.sheetContainer}>
          <View style={styles.header}>
            <TouchableOpacity onPress={() => setSheetModal(false)}>
...
export default AddMarkupLinkProps;
